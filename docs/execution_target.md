...
- `order_submission_enabled` remains false until the separately reviewed order
...
Demo, or exchange-enabled `LOCAL_DRY_RUN` configuration. There is no default
routing fallback when reading `config/app.yaml`.
