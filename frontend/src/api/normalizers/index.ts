...
export type RawStrategyFailureReason = Partial<StrategyFailureReasonSummary> & {
...
export type RawStrategyVersionLineageEntry = Partial<StrategyVersionLineageEntry> & {
  strategy_id?: string | number;
...
export type RawStrategySummary = Partial<StrategyGenerationStrategy> &
  Partial<{
...
export type RawBacktestArtifactManifest = Partial<BacktestArtifactManifest> & {
...
export type RawBacktestMetricSummary = Partial<BacktestMetricSummary> & {
...
export type RawBacktestRunSummary = Partial<BacktestRunSummary> & {
...
export type RawBacktestTaskSummary = Partial<BacktestTaskSummary> & {
...
export type RawBacktestResultSummary = Partial<BacktestResultSummary> & {
  backtest_run_id?: string | number;
...
export type RawHyperoptArtifactManifest = Partial<HyperoptArtifactManifest> & {
  manifest_version?: number | null;
  config_path?: string | null;
  strategy_name?: string | null;
  result_path?: string | null;
...
export type RawHyperoptMetricComparison = Partial<HyperoptMetricComparison> & {
  metric?: string;
  before_value?: number | null;
  after_value?: number | null;
};

export type RawHyperoptComparisonSummary = Partial<HyperoptComparisonSummary> & {
  parent_version_id?: string | number | null;
...
export type RawHyperoptRunSummary = Partial<HyperoptRunSummary> & {
  strategy_name?: string;
  profile_name?: string;
...
export type RawDryRunArtifactManifest = Partial<DryRunArtifactManifest> & {
  manifest_version?: number | null;
  profile_name?: string | null;
...
export type RawDryRunBalanceSummary = Partial<DryRunBalanceSummary> & {
  realized_profit?: number | null;
  unrealized_profit?: number | null;
};

export type RawDryRunOpenTradesSummary = Partial<DryRunOpenTradesSummary> & {
...
export type RawDryRunEventSummary = Partial<DryRunEventSummary> & {
  event_type?: string;
};

export type RawDryRunStatusSnapshot = Partial<DryRunStatusSnapshot> & {
  profile_name?: string | null;
  strategy_version_id?: number | null;
  strategy_name?: string | null;
...
export type RawFreqUILinkMetadata = Partial<FreqUILinkMetadata> & {
...
export type RawDryRunManagementSummary = Partial<DryRunManagementSummary> & {
...
export type RawLiveCandidateRiskCheckSummary = Partial<LiveCandidateRiskCheckSummary> & {
  evidence_ref?: string | null;
  blocked_reason?: string | null;
};

export type RawLiveCandidateProfileSummary = Partial<LiveCandidateProfileSummary> & {
  id?: string | number;
  profile_name?: string;
  strategy_name?: string;
...
export type RawLiveCandidateApprovalDecisionSummary = Partial<LiveCandidateApprovalDecisionSummary> & {
  actor_name?: string;
  actor_role?: string;
  decided_at?: string | null;
};

export type RawLiveCandidateApprovalRecordSummary = Partial<LiveCandidateApprovalRecordSummary> & {
...
export type RawLiveCandidateRollbackStepSummary = Partial<LiveCandidateRollbackStepSummary> & {
  step_order?: number;
};

export type RawLiveCandidateRollbackPlanSummary = Partial<LiveCandidateRollbackPlanSummary> & {
  plan_id?: string | number;
  evidence_refs?: unknown;
  steps?: RawLiveCandidateRollbackStepSummary[];
};

export type RawLiveCandidateDeploymentRecordSummary = Partial<LiveCandidateDeploymentRecordSummary> & {
  record_id?: string | number;
  profile_name?: string;
...
export type RawLiveCandidateMonitoringSourceSummary = Partial<LiveCandidateMonitoringSourceSummary> & {
  collected_at?: string | null;
};

export type RawLiveCandidateAlertSummary = Partial<LiveCandidateAlertSummary> & {
  alert_id?: string | number;
  evidence_ref?: string | null;
};

export type RawLiveCandidateMonitoringSnapshotSummary = Partial<LiveCandidateMonitoringSnapshotSummary> & {
...
export type RawLiveCandidateGovernanceSummary = Partial<LiveCandidateGovernanceSummary> & {
  source_ref?: string | null;
  read_only?: boolean;
  safety_boundary?: string;
...
export type RawRuntimeStatusSummary = Partial<RuntimeStatusSummary> & {
  source_ref?: string | null;
  last_updated?: string | null;
  blocked_reason?: string | null;
  unavailable_reason?: string | null;
...
export type RawRuntimeFallbackStatus = Partial<RuntimeFallbackStatus> & {
  active?: boolean;
};

export type RawRuntimeArtifactLink = Partial<RuntimeArtifactLink>;

export type RawRuntimeSafetyBoundary = Partial<RuntimeSafetyBoundary> & {
  read_only?: boolean;
...
export type RawRuntimeReadOnlyContractSummary = Partial<RuntimeReadOnlyContractSummary> & {
...
export type RawOperatorDiagnosticCheck = Partial<OperatorDiagnosticCheck> & {
  blocked_reason?: string | null;
  unavailable_reason?: string | null;
};

export type RawOperatorArtifactStatus = Partial<OperatorArtifactStatus>;

export type RawOperatorEnvPresence = Partial<OperatorEnvPresence> & {
  value_rendered?: boolean;
};

export type RawOperatorRuntimeContractSummary = Partial<OperatorRuntimeContractSummary> & {
...
export type RawOperatorSafetyBoundary = Partial<OperatorSafetyBoundary> & {
  read_only?: boolean;
...
export type RawOperatorStatusReportSummary = Partial<OperatorStatusReportSummary> & {
  schema_version?: string;
  generated_at?: string | null;
  repo_root?: string;
...
export type RawOperatorAuditEventSummary = Partial<OperatorAuditEventSummary> & {
...
export type RawOperatorDashboardSummary = {
...
export type RawRankingEntry = Partial<RankingEntry> & {
...
export type RawDataSourceTrace = Partial<DataSourceTraceSummary> & {
  source_type?: string;
...
export type RawStrategyGenerationStrategy = Partial<StrategyGenerationStrategy> & {
  current_version_id?: string | number | null;
  created_at?: string | null;
  updated_at?: string | null;
  data_source?: RawDataSourceTrace;
...
export type RawValidationErrorSummary = Partial<ValidationErrorSummary>;

export type RawStrategyVersionFileState = Partial<StrategyVersionFileState> & {
  is_file?: boolean;
...
export type RawStrategyGenerationVersion = Partial<StrategyGenerationVersion> & {
  strategy_id?: string | number;
...
export type RawStrategyGenerationApiResponse = {
...
export type RawDryRunReadinessCheck = {
  name?: string;
  status?: string;
  summary?: string;
  blocked_reason?: string | null;
...
export type RawDryRunReadinessReport = {
  status?: string;
  generated_at?: string;
  generatedAt?: string;
  strategy_version_id?: string | number;
...
export type RawDryRunControlReport = {
  status?: string;
  generated_at?: string;
  generatedAt?: string;
  manifest_path?: string | null;
...
export function normalizeId(value: string | number | undefined): string {
  return value === undefined ? "" : String(value);
}

export function normalizeOptionalId(value: string | number | null | undefined): string | null {
...
export function normalizeNumericRecord(value: unknown): Record<string, number> {
...
export function normalizeMetrics(raw: RawBacktestMetricSummary | undefined): BacktestMetricSummary {
  const source = raw ?? {};
...
export function normalizeHyperoptArtifactManifest(
...
export function normalizeRankingSignal(raw: unknown): RankingSignalSummary {
...
export function normalizeRankingEntry(raw: RawRankingEntry, index: number): RankingEntry {
...
export function normalizeFailureReason(raw: RawStrategyFailureReason): StrategyFailureReasonSummary {
...
export function normalizeLineageEntry(raw: RawStrategyVersionLineageEntry): StrategyVersionLineageEntry {
...
export function normalizeBacktestRun(raw: RawBacktestRunSummary): BacktestRunSummary {
...
export function normalizeBacktestTask(raw: RawBacktestTaskSummary): BacktestTaskSummary {
  const artifactManifest = normalizeArtifactManifest(raw.artifactManifest ?? raw.artifact_manifest ?? raw.manifest);
  const metrics = normalizeMetrics(raw);
  return {
    id: normalizeId(raw.id),
...
export function normalizeBacktestResult(raw: RawBacktestResultSummary): BacktestResultSummary {
  return {
    id: normalizeId(raw.id),
...
export function normalizeHyperoptMetricComparison(raw: RawHyperoptMetricComparison): HyperoptMetricComparison {
...
export function normalizeHyperoptComparison(
...
export function normalizeHyperoptRun(raw: RawHyperoptRunSummary): HyperoptRunSummary {
...
export function normalizeDryRunManifest(raw: RawDryRunArtifactManifest | null | undefined): DryRunArtifactManifest | null {
  if (!raw) {
    return null;
  }
...
export function normalizeDryRunBalance(raw: RawDryRunBalanceSummary | undefined): DryRunBalanceSummary {
  const source = raw ?? {};
  return {
...
export function normalizeDryRunOpenTrades(raw: RawDryRunOpenTradesSummary | undefined): DryRunOpenTradesSummary {
  const source = raw ?? {};
  return {
...
export function normalizeDryRunEvent(raw: RawDryRunEventSummary): DryRunEventSummary {
  return {
...
export function normalizeDryRunSnapshot(raw: RawDryRunStatusSnapshot | undefined): DryRunStatusSnapshot {
  const source = raw ?? {};
  return {
...
export function normalizeFreqUILink(raw: RawFreqUILinkMetadata | undefined): FreqUILinkMetadata {
  const source = raw ?? {};
  return {
...
export function normalizeDryRunManagement(raw: RawDryRunManagementSummary): DryRunManagementSummary {
  return {
...
export function normalizeRiskCheck(raw: RawLiveCandidateRiskCheckSummary): LiveCandidateRiskCheckSummary {
  return {
...
export function normalizeLiveCandidateProfile(raw: RawLiveCandidateProfileSummary): LiveCandidateProfileSummary {
  return {
...
export function normalizeApprovalRecord(raw: RawLiveCandidateApprovalRecordSummary): LiveCandidateApprovalRecordSummary {
  return {
...
export function normalizeRollbackStep(raw: RawLiveCandidateRollbackStepSummary): LiveCandidateRollbackStepSummary {
  return {
...
export function normalizeRollbackPlan(
...
export function normalizeMonitoringSource(
...
export function normalizeAlert(raw: RawLiveCandidateAlertSummary): LiveCandidateAlertSummary {
  return {
...
export function normalizeLiveCandidateGovernance(
...
export function normalizeRuntimeStatusSummary(raw: RawRuntimeStatusSummary | undefined, name: string): RuntimeStatusSummary {
  const source = raw ?? {};
  return {
...
export function normalizeRuntimeFallbackStatus(raw: RawRuntimeFallbackStatus | undefined): RuntimeFallbackStatus {
  const source = raw ?? {};
  return {
...
export function normalizeRuntimeArtifactLink(raw: RawRuntimeArtifactLink): RuntimeArtifactLink {
  return {
...
export function normalizeRuntimeSafety(raw: RawRuntimeSafetyBoundary | undefined): RuntimeSafetyBoundary {
  const source = raw ?? {};
  return {
...
export function normalizeOperatorDiagnosticCheck(raw: RawOperatorDiagnosticCheck): OperatorDiagnosticCheck {
  return {
...
export function normalizeOperatorArtifactStatus(raw: RawOperatorArtifactStatus): OperatorArtifactStatus {
  return {
...
export function normalizeOperatorEnvPresence(raw: RawOperatorEnvPresence): OperatorEnvPresence {
  return {
...
export function normalizeOperatorRuntimeContract(
...
export function normalizeOperatorSafety(raw: RawOperatorSafetyBoundary | undefined): OperatorSafetyBoundary {
  const source = raw ?? {};
  return {
    readOnly: source.readOnly ?? source.read_only ?? true,
...
export function normalizeOperatorStatus(raw: RawOperatorStatusReportSummary): OperatorStatusReportSummary {
  return {
    schemaVersion: raw.schemaVersion ?? raw.schema_version ?? "1",
    status: raw.status ?? "UNAVAILABLE",
    generatedAt: raw.generatedAt ?? raw.generated_at ?? null,
...
export function normalizeAuditEvent(raw: RawOperatorAuditEventSummary): OperatorAuditEventSummary {
  return {
...
export function normalizeOperatorDashboard(raw: RawOperatorDashboardSummary): OperatorDashboardSummary {
  return {
    sourceRef: raw.sourceRef ?? raw.source_ref ?? null,
    readOnly: raw.readOnly ?? raw.read_only ?? true,
...
export function normalizeDataSourceTrace(
...
export function normalizeValidationError(raw: RawValidationErrorSummary): ValidationErrorSummary {
  return {
...
export function normalizeStrategyGenerationRun(raw: RawStrategyGenerationRunDetail | undefined): StrategyGenerationRunDetail {
  const source = raw ?? {};
  return {
...
export function normalizeStrategyGenerationStrategy(
...
export function normalizeStrategyGenerationVersion(raw: RawStrategyGenerationVersion): StrategyGenerationVersion {
...
export function normalizeStrategyVersionFileState(
...
export function normalizeStrategySummary(
...
export function normalizeDryRunControl(raw: RawDryRunControlReport): DryRunControlReport {
  return {
    status: raw.status ?? "BLOCKED",
    generatedAt: raw.generatedAt ?? raw.generated_at ?? "",
    manifestPath: raw.manifestPath ?? raw.manifest_path ?? null,
