            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "Allowed indicator kind values: raw, rsi, ema, sma, atr. Indicators may set source "
                        "to open, high, low, close, or volume; raw requires period 1, calculated indicators "
                        "require period greater than 1, and rsi/atr require source close. Allowed operators: "
                        "<, <=, >, >=, ==, "
